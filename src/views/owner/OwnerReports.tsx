  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Sales Report */}
        <div className="p-5 rounded-3xl bg-white border border-[#EAE5E2] shadow-xs flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="w-10 h-10 rounded-2xl bg-[#F8F6F4] text-[#3B241C] flex items-center justify-center">
              <FileText className="w-5 h-5" />
            </div>
            <h3 className="font-bold text-sm text-[#201A17]">Relatório de Vendas</h3>
          ...
          <button
            onClick={exportSales}
            className="w-full py-2.5 px-4 rounded-xl bg-[#3B241C] text-white text-xs font-bold hover:bg-[#2E1A14] transition flex items-center justify-center gap-1.5 shadow-xs"
          >
        ...
        <div className="p-5 rounded-3xl bg-white border border-[#EAE5E2] shadow-xs flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            ...
            <h3 className="font-bold text-sm text-[#201A17]">Relatório de Estoque</h3>
            <p className="text-xs text-[#746A65] leading-relaxed">
        ...
        <div className="p-5 rounded-3xl bg-white border border-[#EAE5E2] shadow-xs flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            <div className="w-10 h-10 rounded-2xl bg-[#F8F6F4] text-[#237A4B] flex items-center justify-center">
              <CheckCircle2 className="w-5 h-5" />
            </div>
            <h3 className="font-bold text-sm text-[#201A17]">Relatório de Comissões</h3>
            <p className="text-xs text-[#746A65] leading-relaxed">
          ...
          <button
            ...
            className="w-full py-2.5 px-4 rounded-xl bg-[#237A4B] text-white text-xs font-bold hover:bg-[#1b633d] transition flex items-center justify-center gap-1.5 shadow-xs"
          >
            <Download className="w-3.5 h-3.5" />
